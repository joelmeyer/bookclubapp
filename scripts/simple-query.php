...
$apiKey = "AIzaSyBpcv92g4GmNcKXhCZtgHE2DfEY3d3ccrA";
if ($apiKey != 'AIzaSyBpcv92g4GmNcKXhCZtgHE2DfEY3d3ccrA') {
...
$optParams = array();//'filter' => 'free-ebooks');
$request = $service->volumes->listVolumes('Breakfast', $optParams);
